        ...
        <div className="signup-grid">
          <div data-reveal="slide-left">
            ...
            <div style={{ marginTop: 32, paddingTop: 32, borderTop: "1px solid rgba(26,10,18,0.2)" }}>
              ...
              <a href="mailto:sylvain@suissemoi.com" style={{ display: "block", marginTop: 8, fontFamily: "var(--font-mono)", fontSize: 14, color: "var(--dark)" }}>
                sylvain@suissemoi.com
              </a>
      ...
      <div className="footer-grid">
        ...
        <div className="foot-col">
          ...
          <ul>
            ...
            <li><a href="mailto:sylvain@suissemoi.com">sylvain@suissemoi.com</a></li>
